...
/home/selenium/certificate_actions/bash/install_certificate.sh &
/home/selenium/certificate_actions/bash/authorize_certificate.sh &
...
if [ "$ENABLE_VNC" == "true" ]; then
    x11vnc -display "$DISPLAY" -cursor arrow -multiptr -passwd selenoid -shared -forever -loop500 -rfbport 5900 -rfbportv6 5900 -logfile /dev/null &
    X11VNC_PID=$!
fi
